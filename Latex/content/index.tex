...
% http://www.webpagecontent.com/arc_archive/124/5/
	...
	% Usability lässt sich nicht via Testscript Testen, sondern hängt immer ab von den verschiedenen Einflüssen der Benutzer
	...
	% mögliche Testprozesse
	% automatische vs. gesteuert

\chapter{thEvaluator}
	\section{Zielbestimmungen}
	% Entwickler muss für bestimmte Sachen Events definieren
	% vs.
	% Tool kommt ohne Definierung von Events aus
	\section{Produktfunktionen}
	% Was ist möglich, wie weit gehen die Auswertungen
	...
	\section{Extension}
		...
		% Problematik der erhöhten Datenmenge
	\section{API}
		\subsection{Architektur}
		% express, welche Models gibt es
		% Welche Dependencies , Deploymentprozess
		\subsection{Asynchronität in nodeJS}
		% Möglichkeiten zur Lösung über closures, callbacks, Modulen wie async
	...
	\section{Webapplikation}
		...
		% warum welche Attribute und Bedeutung (zbs. Auflösung, required)
		...
		% wann kann man mögliche Resultate ableiten
		\subsection{Qualitätsanforderungen}
	\section{Zukunftsaussichten}
	% Einsatz der Webcam für Eyetracking
