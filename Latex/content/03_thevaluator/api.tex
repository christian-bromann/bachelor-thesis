...
\newglossaryentry{joins}{name=SQL Joins, description={ist die Bezeichnung für das Zusammenfügen verschiedener Spalten einer oder mehrere SQL-Tabellen, basierend auf ein gemeinsames Feld zwischen diesen Tabellen}}
\newglossaryentry{Overhead}{name=Overhead, description={ist die Datenmenge, die nicht zu den Nutzdaten zählt}}
\newglossaryentry{Latenz}{name=Latenz, description={bezeichnet den Zeitraum zwischen einer Aktion und dem Eintreten dessen Reaktion}}
\newglossaryentry{Log-Datei}{name=Log-Datei, description={beinhaltet die Ausgaben der Applikation über bestimmte Aktionen oder Prozesse}}
