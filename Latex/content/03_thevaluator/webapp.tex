...
\newglossaryentry{SVG}{name=SVG, description={bezeichnet die Spezifikation zur Beschreibung von Vektorgrafiken}}
...
\\
Für die Visualisierung der Daten wurde das bekannte \textit{d3}-Framework\footnote{\url{http://d3js.org/}} verwendet. Es nutzt den \Gls{DOM}, um mit \Gls{SVG}-Elementen Daten zu visualisieren.
