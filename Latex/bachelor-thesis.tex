...
\lstdefinelanguage{JavaScript}{
  ...
  morestring=[b]',
  morestring=[b]",
  emph=[1]{prototype,methodName,createElement,append,require,writeFile,log,asynchronousFunction,series,then,post,stringify,send,listen,capturePage,getSelected,sendMessage,setTimeout,captureVisibleTab,onload,drawImage,addListener,cb,takeScreenshot},
...
\frontmatter 								% Titelblätter und Erklärung
    \include{./preface/title} 					% Titelblatt mit Beuth Logo, Titel und Name
    \thispagestyle{empty}
    \cleardoublepage
    \include{./preface/clarification}				% Erklärung zur selbstständigen Arbeit
    \include{./preface/abstract} 					% Abstract
